...
pub enum Block {
    ...
    PumpkinMature = 108,
    /// 乙太花冠（世界奇觀·乙太世界樹 v1，ROADMAP 939）——世界唯一一座天然大奇觀的招牌方塊：
    ...
    /// id 111：0~110 皆已用（純物品/方塊），111 是首個空號。
    AetherBloom = 111,
}
...
/// 世界奇觀·乙太世界樹 v1（ROADMAP 939）——世界唯一一株巨型古樹的方塊。
///
...
pub fn block_at(wx: i32, wy: i32, wz: i32) -> Block {
    ...
    if wy > h {
        ...
        // 世界奇觀·乙太世界樹（ROADMAP 939）：全世界唯一一株巨型古樹，優先於一般樹——
